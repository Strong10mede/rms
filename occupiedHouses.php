...
$sql = 'SELECT
        ...
        FROM
          house
        JOIN assigned ON assigned.house_id = house.house_id
        JOIN apartment ON apartment.apartment_id = house.apartment_id
        JOIN owner ON apartment.owner_id = owner.owner_id
        JOIN tenant ON assigned.tenant_id = tenant.tenant_id;';
$result = mysqli_query($conn, $sql);
$occupied_houses = mysqli_fetch_all($result, MYSQLI_ASSOC);
...
<div class="banner_blur ">
  ...
  <div class="p-5 flex gap-4">
    ...
    <a href="/rms/vacantHouses.php" class="btn secondary">Vacant Houses</a>
        ...
        <table class="min-w-full divide-y divide-gray-200">
          <thead class="bg-gray-50">
            <tr>
              ...
              <th scope="col" class="px-2 text-center py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider  ">
                Status
              </th>
          ...
          <tbody class="bg-white divide-y divide-gray-200">
            <?php foreach ($occupied_houses as $house) { ?>
              <tr>
                ...
                <td class="px-4 py-4">
                  <div class="max-w-xs w-28 break-words">
                    <a class="link" href="/rms/tenantDetails.php?id=<?php echo $house["tenant_id"] ?>">
